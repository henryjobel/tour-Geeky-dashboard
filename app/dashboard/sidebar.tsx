          ...
          <div className="flex items-center gap-3">
            <Link href="/">
              <Icon
                ...
                className="w-9 h-9 p-2 text-white bg-blue-600 rounded-full"
              />
            </Link>
        ...
        <div className="h-full px-3 py-4 overflow-y-auto">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            >
              <Icon
                icon="proicons:airplane"
                className="w-12 h-12 p-2 text-white bg-blue-600 rounded-full"
              />
          ...
          <ul className="space-y-2">
                ...
                <ul className="pl-8 space-y-2">
                  ...
                  <li>
                    <Link
                      ...
                      onClick={() => handleSetActiveItem("Availability")}
                    >
                      <Icon icon="ion:bag-check-outline" className="text-xl" />
                      Availability
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      href="/product-management/special-offer"
                      className={` p-2 flex items-center gap-2 ${
                        activeItem === "special-offer"
                          ? "text-white"
                          : "text-gray-400"
                      } hover:bg-gray-700`}
                      onClick={() => handleSetActiveItem("special-offer")}
                    >
                      <Icon
            ...
            <li>
              <Link
                href="/reports"
                className={`flex items-center p-2 ${
                  activeItem === "Reports" ? "text-white" : "text-gray-400"
                } hover:bg-gray-700`}
                onClick={() => handleSetActiveItem("Reports")}
              >
                <Icon
                  icon="mdi:chart-bar"
                  className={`w-5 h-5 ${
                ...
                />
                {!isSidebarMinimized && <span className="ml-3">Reports</span>}
              </Link>
            </li>
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 ${
                  activeItem === "Marketing Tools"
                    ? "text-white"
                    : "text-gray-400"
                } hover:bg-gray-700`}
                onClick={() => handleSetActiveItem("Marketing Tools")}
              >
                <Icon
                ...
                />
                {!isSidebarMinimized && (
                  <span className="ml-3">Marketing Tools</span>
                )}
              </Link>
            </li>
